...
SECRET_KEY = 'django-insecure-ed=2ditud*^uy%w+owq8w-d6g+d2)&0rswuqe%mf+mf8v%xj-o'
...
MATERIAL_ADMIN_SITE = {
    ...
    # 'LOGOUT_BG':  'images/home.jpg',  # Admin site background on login/logout pages (path to static should be specified)
